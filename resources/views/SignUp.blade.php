                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="post">
                                <div class="form-group"><input class="form-control form-control-user" type="email" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Full Name" name="Name" required=""></div>
                                <div class="form-group"><input class="form-control form-control-user" type="email" id="exampleInputEmail-3" aria-describedby="emailHelp" placeholder="NIC" name="NIC" required=""></div>
                                <div class="form-group"><input class="form-control form-control-user" type="email" id="exampleInputEmail-4" aria-describedby="emailHelp" placeholder="Password" name="Password" required=""></div>
