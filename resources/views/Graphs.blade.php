...
<script>
    ...
    let myChart3 = new Chart(ctx3, {
        type: 'pie',
        data: {
            labels: ['Hambanthota','Jaffna','Colombo','Ampara','Anuradhapura','Badulla','Batticaloa','Mannar','Gampaha','Galle','Kaluthara','Kandy',''],
            datasets: [{
                label: '# of Reports',
                data: [{{$Location[0]}},{{$Location[1]}},{{$Location[2]}},{{$Location[3]}},{{$Location[4]}},{{$Location[5]}},{{$Location[6]}},{{$Location[7]}},{{$Location[8]}},{{$Location[9]}},{{$Location[10]}},{{$Location[11]}}],
                backgroundColor: [
                    'rgba(54, 162, 235, 1)',
                    'rgba(50, 168, 82, 1)',
                    'rgba(222, 140, 255, 1)',
